...
# Examples:
#
#   recipes = recipe.create([{ name: 'Star Wars' }, { name: 'Lord of the Rings' }])
#   Character.create(name: 'Luke', recipe: recipes.first)
...
recipe_e = Recipe.create(
    ...
    "release_year"=> "1991",
    "rt_score"=> "100",
    "image" =>"./src/images/recipes/only_yesterday.jpg"
)

recipe_f = Recipe.create(
    "title"=> "Porco Rosso",
    "description"=> "Porco Rosso, known in Japan as Crimson Pig (Kurenai no Buta) is the sixth animated film by Hayao Miyazaki and released in 1992. You're introduced to an Italian World War I fighter ace, now living as a freelance bounty hunter chasing 'air pirates' in the Adriatic Sea. He has been given a curse that changed his head to that of a pig. Once called Marco Pagot, he is now known to the world as 'Porco Rosso', Italian for 'Red Pig.'",
    "director_id"=> director_a.id,
    "release_year"=> "1992",
    "rt_score"=> "94",
    "image" =>"./src/images/recipes/porco_rosso.jpg"
)

recipe_g = Recipe.create(
    "title"=> "Pom Poko",
    ...
    "release_year"=> "1994",
    "rt_score"=> "78",
    "image" => "./src/images/recipes/pom_poko.jpg"
)

recipe_h = Recipe.create(
    ...
    "release_year"=> "1995",
    "rt_score"=> "91",
    "image" =>"./src/images/recipes/whisper.jpg"
)

recipe_i = Recipe.create(
  ...
  "release_year"=> "1997",
  "rt_score"=> "92",
  "image" =>"./src/images/recipes/mononoke.jpg"
)
...
character_e = Character.create(
    ...
    "recipe_id"=> recipe_e.id,
    "image" =>"./src/images/characters/taeko.jpg"
)
character_f = Character.create(
    "name"=> "Setsuko Yokokawa",
    "introduction"=> "Setsuko Yokokawa is a preschool student and the younger sister of Seita Yokokawa in the Studio Ghibli recipe Grave of the Fireflies. She was born in 1941, but later dies in 1945 towards the end of the film.",
...
character_g = Character.create(
    ...
    "recipe_id"=> recipe_c.id,
    "image" => "./src/images/characters/totoro.jpg"
)

character_h = Character.create(
    "name"=> "Marco Pagot",
    "introduction"=> "Marco Pagot is the protagonist in the recipe Porco Rosso. He is a human who was transformed into a pig. He is known as Porco Rosso, the bounty hunter.",
    "recipe_id"=> recipe_f.id,
